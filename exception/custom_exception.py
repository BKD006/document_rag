...
class DocumentRAGException(Exception):
    def __init__(self, error_message, error_details: Optional[object]=None):
        ...
        # Fully pretty traceback (if available)
    ...
    def __str__(self):
        # Compact, logger-friendly message (no leading space)
    ...
    def __repr__(self):
        return f"DocumentRAGException(file={self.file_name!r}, line={self.lineno}, message={self.error_message!r})"