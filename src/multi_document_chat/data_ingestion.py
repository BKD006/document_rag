...
class DocumentIngestor:
    ...
    def __init__(self, temp_dir:str="data/multi_document_chat", faiss_dir: str="faiss_index", session_id: str |None=None):
        try:
            ...
            raise DocumentalRagException("Initialization error in DocumentIngestor", sys)
        ...
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                if ext not in self.SUPPORTED_FILE_EXTENSIONS:
                    self.log.warning("Unsubscribe file skipped", filename=uploaded_file.name)
                    continue
            ...
            if not documents:
                raise DocumentalRagException("No valid documents loaded", sys)
            ...
            raise DocumentalRagException("Ingestor error in DocumentIngestor", sys)
    ...
    def _create_retriever(self, documents):
        try:
            ...
            raise DocumentalRagException("Retrieval error in DocumentIngestor", sys)
